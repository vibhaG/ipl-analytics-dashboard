...
DHRUV_BATTER_NAME = "Dhruv Jurel"
DHRUV_BATTER_LABEL = "Dhruv Jurel"
RUTHERFORD_BATTER_NAME = "SE Rutherford"
RUTHERFORD_BATTER_LABEL = "Sherfane Rutherford"
SHIVAM_BATTER_NAME = "S Dube"
SHIVAM_BATTER_LABEL = "Shivam Dube"
JITESH_BATTER_NAME = "JM Sharma"
JITESH_BATTER_LABEL = "Jitesh Sharma"
SHASHANK_BATTER_NAME = "Shashank Singh"
SHASHANK_BATTER_LABEL = "Shashank Singh"
ASHUTOSH_BATTER_NAME = "Ashutosh Sharma"
ASHUTOSH_BATTER_LABEL = "Ashutosh Sharma"
RAMANDEEP_BATTER_NAME = "Ramandeep Singh"
RAMANDEEP_BATTER_LABEL = "Ramandeep Singh"
ANIKET_BATTER_NAME = "Aniket Verma"
ANIKET_BATTER_LABEL = "Aniket Verma"
RIYAN_BATTER_NAME = "R Parag"
RIYAN_BATTER_LABEL = "Riyan Parag"
SHREYAS_BATTER_NAME = "SS Iyer"
SHREYAS_BATTER_LABEL = "Shreyas Iyer"
TILAK_BATTER_NAME = "Tilak Varma"
TILAK_BATTER_LABEL = "Tilak Verma"
AXAR_BATTER_NAME = "AR Patel"
AXAR_BATTER_LABEL = "Axar Patel"
HARDIK_BATTER_NAME = "HH Pandya"
HARDIK_BATTER_LABEL = "Hardik Pandya"
RINKU_BATTER_NAME = "RK Singh"
RINKU_BATTER_LABEL = "Rinku Singh"
TODAY_BATTER_KEYS = [
    NEHAL_BATTER_NAME,
    NAMAN_BATTER_NAME,
...
TODAY_BATTER_DISPLAY = {
    ...
    RIYAN_BATTER_NAME: RIYAN_BATTER_LABEL,
    SHREYAS_BATTER_NAME: SHREYAS_BATTER_LABEL,
    TILAK_BATTER_NAME: TILAK_BATTER_LABEL,
    AXAR_BATTER_NAME: AXAR_BATTER_LABEL,
    HARDIK_BATTER_NAME: HARDIK_BATTER_LABEL,
...
def render_dhruv_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Dhruv Jurel")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, DHRUV_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {DHRUV_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, DHRUV_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {DHRUV_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_rutherford_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Sherfane Rutherford")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, RUTHERFORD_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {RUTHERFORD_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, RUTHERFORD_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {RUTHERFORD_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_shivam_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Shivam Dube")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, SHIVAM_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {SHIVAM_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, SHIVAM_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {SHIVAM_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_jitesh_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Jitesh Sharma")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, JITESH_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {JITESH_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, JITESH_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {JITESH_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_shashank_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Shashank Singh")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, SHASHANK_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {SHASHANK_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, SHASHANK_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {SHASHANK_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_ashutosh_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Ashutosh Sharma")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, ASHUTOSH_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {ASHUTOSH_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, ASHUTOSH_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {ASHUTOSH_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_ramandeep_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Ramandeep Singh")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, RAMANDEEP_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {RAMANDEEP_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, RAMANDEEP_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {RAMANDEEP_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_aniket_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Aniket Verma")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, ANIKET_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {ANIKET_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, ANIKET_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {ANIKET_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_riyan_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Riyan Parag")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, RIYAN_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {RIYAN_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, RIYAN_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {RIYAN_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_shreyas_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Shreyas Iyer")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, SHREYAS_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {SHREYAS_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, SHREYAS_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {SHREYAS_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_tilak_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Tilak Verma")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, TILAK_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {TILAK_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, TILAK_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {TILAK_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_axar_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Axar Patel")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, AXAR_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {AXAR_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, AXAR_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {AXAR_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_hardik_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Hardik Pandya")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, HARDIK_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {HARDIK_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, HARDIK_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {HARDIK_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
def render_rinku_batter_summary_tab(focus_df: pd.DataFrame, available_years: list[int]) -> None:
    st.subheader("Batter Summary - Rinku Singh")
    st.caption(
        "Year-wise and consolidated summary for runs and strike rate by batting position and phase "
        "(Overs 1-6, Overs 7-14, Overs 15-20)."
    )
    ...
    for idx, year in enumerate(available_years):
        with scope_tabs[idx]:
            scoped_df = focus_df[focus_df["season"] == year].copy()
            position_table, phase_table = batter_position_and_phase_summary(scoped_df, RINKU_BATTER_NAME)
            if position_table.empty and phase_table.empty:
                st.warning(f"No batting records found for {RINKU_BATTER_LABEL} in {year}.")
                continue
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
    ...
    with scope_tabs[-1]:
        position_table, phase_table = batter_position_and_phase_summary(focus_df, RINKU_BATTER_NAME)
        if position_table.empty and phase_table.empty:
            st.warning(f"No batting records found for {RINKU_BATTER_LABEL} in 2023-2025.")
        else:
            left, right = st.columns(2)
            with left:
                st.markdown("### Runs by Batting Position")
...
main_tab, phase_runs_tab, phase_wickets_tab, batter_impact_tab, bowling_impact_tab, batter_summary_tab, dot_ball_tab, boundary_impact_tab, bowling_avg_tab, batter_variance_tab, batter_30plus_tab, bowler_2w_tab, venue_summary_tab, franchise_consistency_tab, best_batters_venue_tab, home_batting_tab, home_bowling_tab, away_batting_tab, away_bowling_tab, batter_home_away_variance_tab, bowler_home_away_variance_tab, nehal_summary_tab, naman_summary_tab, angkrish_summary_tab, ayush_summary_tab, dewald_summary_tab, rajat_summary_tab, dhruv_summary_tab, rutherford_summary_tab, shivam_summary_tab, jitesh_summary_tab, shashank_summary_tab, ashutosh_summary_tab, ramandeep_summary_tab, aniket_summary_tab, riyan_summary_tab, shreyas_summary_tab, tilak_summary_tab, axar_summary_tab, hardik_summary_tab, rinku_summary_tab, today_batters_sr_tab, siraj_bowler_tab, shami_bowler_tab, bhuvi_bowler_tab, archer_bowler_tab, deepak_bowler_tab, yash_bowler_tab, khaleel_bowler_tab, vaibhav_bowler_tab, cummins_bowler_tab, unadkat_bowler_tab, avesh_bowler_tab, starc_bowler_tab, lungi_bowler_tab, omerzai_bowler_tab, deshpande_bowler_tab, rabada_bowler_tab, target_bowler_rank_tab = st.tabs(
    [
        ...
        "Batter summary - Dhruv",
        "Batter summary - Rutherford",
        "Batter summary - Shivam",
        "Batter summary - Jitesh",
        "Batter summary - Shashank",
        "Batter summary - Ashutosh",
        "Batter summary - Ramandeep",
        "Batter summary - Aniket",
        "Batter summary - Riyan",
        "Batter summary - Shreyas",
        "Batter summary - Tilak",
        "Batter summary - Axar",
...
with dhruv_summary_tab:
    render_dhruv_batter_summary_tab(focus_df, available_years)


with rutherford_summary_tab:
    render_rutherford_batter_summary_tab(focus_df, available_years)


with shivam_summary_tab:
    render_shivam_batter_summary_tab(focus_df, available_years)


with jitesh_summary_tab:
    render_jitesh_batter_summary_tab(focus_df, available_years)


with shashank_summary_tab:
    render_shashank_batter_summary_tab(focus_df, available_years)


with ashutosh_summary_tab:
    render_ashutosh_batter_summary_tab(focus_df, available_years)


with ramandeep_summary_tab:
    render_ramandeep_batter_summary_tab(focus_df, available_years)
...
with riyan_summary_tab:
    render_riyan_batter_summary_tab(focus_df, available_years)


with shreyas_summary_tab:
    render_shreyas_batter_summary_tab(focus_df, available_years)


with tilak_summary_tab:
    render_tilak_batter_summary_tab(focus_df, available_years)


with axar_summary_tab:
    render_axar_batter_summary_tab(focus_df, available_years)


with hardik_summary_tab:
    render_hardik_batter_summary_tab(focus_df, available_years)
